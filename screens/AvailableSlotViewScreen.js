...
class AvailableSlotViewScreen extends Component {
    ...
    static navigationOptions = ({ navigation }) => {
        const Breakdata = navigation.getParam('Breakdata', '');
        return {
                        ...
                        <MenuOptions style={{
                            ...
                            <MenuOption onSelect={() => {
                                Alert.alert(
                                    ...
                                    {
                                        text: 'OK',
                                        onPress: () => { navigation.state.params.deleteBreakIdCallback(Breakdata.slotid); navigation.pop(1); }
    ...
    async componentDidMount() {
        ...
        //ANJALI
        console.log("employeeTYPEBREAKDATA", this.props.navigation.getParam('Breakdata').employeeids.split(",").length)
        if (this.props.navigation.getParam('Breakdata')) {
            this.setState({
                Breakdata: this.props.navigation.getParam('Breakdata'),
            })
        }
    }
                        ...
                        onPress={() => {
                            this.toggleEmployeeModal(),
                                this.setState(prevState => {
                                    return {
                                        ...prevState,
                                        employees: Object.values(prevState.employees).map(e => {
                                            if (e.selected == true)
                                                e.isDone = true;
                                            else e.isDone = false;
                                            return e;
                                        }),
                                        selectedEmployeesCount: Object.values(prevState.employees).filter(x => x.selected == true)
                                            .map(emp => {
                                                return emp.user.id;
                                            })
                ...
                <View style={{
                    ...
                    <View style={{ height: 60, width: '100%' }}>
                                ...
                                <View style={{
                                    ...
                                    alignItems: 'center',
                                        ...
                                        page == 'slot' ? <Icon name={"expand"} type={"solid"} size={19} color={"#FFFFFF"} />
                                            : <Icon name={"mug-hot"} type={"solid"} size={19} color={"#ffffff"} />
                                    }
                                </View>
                                <View style={{
                                    flex: 5,
                                    ...
                                    {/* ANJALI */}
                                    <Text style={[styles.textInput, { color: '#ffffff' }]}>{Breakdata.customer}</Text>
                                    {/* <TextInput
                        ...
                        <View style={{
                            ...
                            ANJALI
                            <Text style={[styles.textInput, { color: '#000000' }]}>{Breakdata.customer}</Text>
                            <TextInput
                                        style={[styles.textInput, (page == 'slot' ? { color: '#FFFFFF' } : { color: '#888888' })]}
                                        placeholder={"Title"}
                                        onChangeText={(text) => this.onChangeHandle("title", text)}
                    ...
                    <View style={{
                        ...
                        <View style={styles.rowStyle1}>
                            ...
                            <View style={{
                                ...
                                <Text style={styles.textStyle5}>All Employee ({Breakdata.employeeids.split(",").length})</Text>
                                {/* : <Text
                                        style={{
                                            fontFamily: 'open-sans-hebrew',
                                            fontSize: 16,
                        ...
                        <View style={styles.rowStyle1}>
                            ...
                            <View style={{
                                ...
                                <Text style={{
                                    ...
                                    fontSize: 16,
                                    color: '#AAAAAA'
                                }}>{moment(Breakdata.startTime, "YYYY-MM-DD HH:mm:ss").format("DD/MM/YYYY")}
                                    {(this.checkSameDay(Breakdata.startTime)) ? ' (Today)' : ''}</Text>
                                {/* : <Text
                        ...
                        <View style={styles.rowStyle1}>
                            ...
                            <View style={{
                                ...
                                <Text style={{
                                    ...
                                    fontSize: 16,
                                    color: '#AAAAAA'
                                }}>{Breakdata.startTime.format("HH:mm")} - {Breakdata.startTime.clone().add(Breakdata.duration, "minutes").format("HH:mm")}</Text>
                                {/* // : <Text
...
export default connect(mapStateToProps, mapDispatchToProps)(AvailableSlotViewScreen)
